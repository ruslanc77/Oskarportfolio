              ...
              <Grid container className={classes.leftContainer}>
                <Grid item md={6} sm={6} className={classes.iconsGrid}>
                  <Link
                    ...
                    href="https://github.com/rising9719"
                    target="_blank"
                  ...
                  <Link
                    className={classes.socialItem}
                    href="https://www.linkedin.com/in/kosciuk-oskar-rostik-1a0363348/"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                  ...
                  <Link
                    className={classes.socialItem}
                    href="mailto:kosciukos94@gmail.com"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                    <MailIcon fontSize="large" className={classes.icon} />
                    <Typography>kosciukos94@gmail.com</Typography>
                  </Link>
                </Grid>
