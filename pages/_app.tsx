  ...
  return (
    <>
      <Head>
        ...
        />
        {/* <title>Oskar Ryszard</title> */}
        {/* PWA primary color */}
        <meta name="theme-color" content="#161625" />
        {/* <!-- Primary Meta Tags --> */}
        <meta name="title" content="Oskar Ryszard" />
        <meta
          name="description"
          content="Hi, I am Oskar Ryszard, an talent React Native developer."
          key="description"
        />
        ...
        />
        <meta property="og:title" content="Oskar Ryszard" />
        <meta
        ...
        <meta
          ...
          content={`https://${process.env.NEXT_PUBLIC_VERCEL_URL}`}
        />
        <meta property="twitter:title" content="Oskar Ryszard" />
        <meta
      ...
      <AppBar component="nav">
        <Toolbar>
          ...
          <Typography
            ...
            variant="h6"
          >
            <Image src="/assets/icons/flutter.png"
              height="50"
              width="70" />
          </Typography>
          {/* </Link> */}
